...
![example img](/assets/posts/programmers/133500/example1.png)
...
- 예제 #2  
  ...
  ![example img](/assets/posts/programmers/133500/example2.png)
...
- 조건 1. _`lighthouse`의 길이 = `n – 1`_  
  ...
  ![description img](/assets/posts/programmers/133500/description1.png)

- 조건 2. _모든 등대는 서로 다른 등대로 이동할 수 있는 뱃길이 존재하도록 입력이 주어집니다._  
  `모든 등대는 다른 등대와 길이 연결되어 있다`라는 이 조건은 아래와 같은 형태의 뱃길이 존재하지 않음을 알려줍니다.

  ![description img](/assets/posts/programmers/133500/description2.png)
